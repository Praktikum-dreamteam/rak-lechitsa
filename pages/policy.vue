<template>
  <div>
    ...
    <ol class="policy-points">
      <li class="policy-point__item">
        <h2 class="policy-point__subtitle">Общие положения.</h2>
        <p class="policy-point__text">
        ...
        <ol class="policy-subpoints">
          <li class="policy-subpoint__item">
            <p class="policy-subpoint__text">
      ...
      <li class="policy-point__item">
        <h2 class="policy-point__subtitle">
      ...
      <li class="policy-point__item">
        ...
        <ol class="policy-subpoints">
          <li class="policy-subpoint__item">
            <p class="policy-subpoint__text">Фамилия, имя, отчество;</p>
          </li>
          <li class="policy-subpoint__item">
            <p class="policy-subpoint__text">Электронный адрес;</p>
          </li>
          <li class="policy-subpoint__item">
            <p class="policy-subpoint__text">Номера телефонов;</p>
          </li>
          <li class="policy-subpoint__item">
            <p class="policy-subpoint__text">
          ...
          <li class="policy-subpoint__item">
            <p class="policy-subpoint__text">Фотографии;</p>
          </li>
          <li class="policy-subpoint__item">
            <p class="policy-subpoint__text">
      ...
      <li class="policy-point__item">
        <h2 class="policy-point__subtitle">Заключительные положения</h2>
        <ol class="policy-subpoints">
          <li class="policy-subpoint__item">
            <p class="policy-subpoint__text">
